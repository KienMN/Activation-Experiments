...
def insert_layer_nonseq(model, layer_regex, insert_layer_factory, insert_layer_name=None, position='after'):
  """
  Function to change intermediate layer in Keras Model.
  ...
  layer_regex: str
    Regular expression of layers' name to change.

  insert_layer_factory: fn
    Layer to insert.

  insert_layer_name: str
    Name of inserted layer.

  position: str, options=['before', 'after', 'replace'], default: 'after'
    Position to insert new layer.
